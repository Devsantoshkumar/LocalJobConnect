        ...
        <div class="col-md-6 col-12 my-4">
            <ul class="list-unstyled d-flex px-sm-5 px-2">
                <li class="footer-icon">
                    <a href="#!" class="text-decoration-none rounded-circle"><i class="fa-brands fa-facebook-f"></i></a>
                </li>
                <li class="footer-icon">
                    <a href="#!" class="text-decoration-none rounded-circle"><i class="fa-brands fa-twitter"></i></a>
                </li>
                <li class="footer-icon">
